...
const AuthPage = () => {
  ...
  const redirectTo = params.get("redirect") ?? "/assinantes";
  ...
  return (
    <>
      <SEO
        title="Entrar — Vitória News"
        description="Entre ou crie sua conta no Vitória News para acessar conteúdo exclusivo."
      />
      <section className="pt-24 pb-16 px-4 min-h-screen flex items-center">
        <div className="container mx-auto max-w-md">
          ...
          >
            <h1 className="font-display text-2xl font-bold text-center mb-1">Acesse sua conta</h1>
            <p className="text-sm text-muted-foreground text-center mb-6">
              Entre para acessar o conteúdo exclusivo de assinantes
            </p>
            ...
            <p className="text-xs text-muted-foreground text-center mt-6">
              ...
              <Link to="/termos" className="text-gold underline">Termos</Link> e{" "}
              <Link to="/privacidade" className="text-gold underline">Privacidade</Link>.
            </p>
          </motion.div>
        </div>
      </section>
